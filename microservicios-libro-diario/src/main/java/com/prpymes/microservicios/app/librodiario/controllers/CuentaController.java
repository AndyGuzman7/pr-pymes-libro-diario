...
import com.prpymes.microservicios.app.librodiario.cuenta.services.CuentaService;
...
public class CuentaController {
	...
	public ResponseEntity<?> borrarLogico(@RequestBody Cuentas cuenta,@PathVariable Long id){
		Optional<Cuentas> o = service.findById(id);
		if(o.isEmpty()) {
			return ResponseEntity.notFound().build();
		}
