...
public interface LibroDiarioRepository extends CrudRepository<LibroDiario, Long> {
	...
	@Query("select distinct l from LibroDiario l join fetch l.detalles d where d.libroDiario = l.idLibroDiario and l.fecha >= :fecha_inicio and l.fecha <= :fecha_fin and l.tipoLibro = :tipo_libro")
