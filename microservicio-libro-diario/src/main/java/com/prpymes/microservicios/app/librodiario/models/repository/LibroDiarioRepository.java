...
public interface LibroDiarioRepository extends CrudRepository<LibroDiario, Long> {
	...
	@Query("select distinct l from LibroDiario l join fetch l.detalles d where d.libroDiario = l.idLibroDiario and l.fecha between :fecha_inicio and :fecha_fin and l.tipoLibro = :tipo_libro")
	...
	public Page<LibroDiario> findByOrderByIdLibroDiarioAsc(Pageable pageable);
}
